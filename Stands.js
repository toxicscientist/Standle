...
function check(input) {
    if (input == standname) {
        savedCopy += `${"✅✅✅✅✅✅✅"}`
        savedCopy = savedCopy.replace('WubWub', `I got Standle #${standle} in ${6-lives+1} guesses\n`)
        ...
        <p /><button onclick="copy(savedCopy)" id="copy">🔗</button>
        `
        ...
        `
        if(lives == 0){
            savedCopy = savedCopy.replace('WubWub', `I did not get Standle #${standle}\n`)
